  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4 py-8">
      <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-5xl">
        ...
        {/* Paragraphs */}
        <p className="text-gray-700 mb-4 leading-relaxed text-justify sm:text-base md:text-lg">
          The <span className="font-semibold">Centre for Development of Advanced Computing (C-DAC), New Delhi</span> is one of the key centres of C-DAC, an autonomous scientific society under the <span className="font-semibold">Ministry of Electronics and Information Technology (MeitY), Government of India</span>. C-DAC New Delhi plays a significant role in carrying out research, development, training, and consultancy in advanced areas of Information Technology, Electronics, and Digital Governance aligned with national priorities.
        </p>

        <p className="text-gray-700 mb-4 leading-relaxed text-justify sm:text-base md:text-lg">
          C-DAC New Delhi has been actively contributing to the design and implementation of large-scale national e-Governance and Digital India initiatives. The centre focuses on areas such as <span className="font-semibold">Cyber Security, e-Governance, Software Technologies, Data Analytics, Artificial Intelligence, Blockchain, Cloud Computing</span> and IT infrastructure for government systems.
        </p>
        ...
        <p className="text-gray-700 leading-relaxed text-justify sm:text-base md:text-lg">
